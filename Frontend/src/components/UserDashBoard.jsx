...
import {
  FaGoogle, FaDownload, FaWalking, FaFire, FaTint, FaBed, FaBars, FaTimes,
  FaUser, FaBullseye, FaHistory, FaAppleAlt, FaUsers, FaSignOutAlt, FaPlus,
  FaDumbbell
} from "react-icons/fa";
...
const UserDashboard = () => {
  ...
  const menuItems = [
    ...
    { label: "Workout", path: "/workout", icon: <FaDumbbell /> }, // Updated here
    { label: "Nutrition", path: "/meals", icon: <FaAppleAlt /> },
